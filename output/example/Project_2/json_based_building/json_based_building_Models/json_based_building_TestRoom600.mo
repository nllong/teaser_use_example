...
within Project_2.json_based_building.json_based_building_Models;
model json_based_building_TestRoom600
  "This is the simulation model of TestRoom600 within building json_based_building with traceable ID None"

  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    calTSky=Buildings.BoundaryConditions.Types.SkyTemperatureCalculation.HorizontalRadiation,
    computeWetBulbTemperature=false,
    filNam=Modelica.Utilities.Files.loadResource(
        "modelica://Project_2/USA_CO_Aspen-Pitkin.County-Sardy.Field.724676_TMY3.mos"))
    "Weather data reader"
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.046492744695893)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00040176311980066984},
    CExt={620991.3872950586},
    hRad=5.129999999999999,
    AInt=48.0,
    hConInt=4.130000000000001,
    nInt=1,
    RInt={0.0012367731101057835},
    CInt={935138.3085062401},
    RWin=0.013333333333333334,
    RExtRem=0.02773166006079232,
    AFloor=0.0,
    hConFloor=0.0,
    nFloor=1,
    RFloor={0.0},
    ...
    hConRoof=1.0,
    nRoof=1,
    RRoof={0.0005507914363742008},
    RRoofRem=0.06180783951600674,
    CRoof={381586.7162408022},
    ...
    AExt={9.600000000000001, 16.200000000000003, 16.200000000000003, 21.6})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.15094339622641512, 0.2547169811320755, 0.2547169811320755, 0.33962264150943394},
    wfWin={1.0, 0.0, 0.0, 0.0},
    withLongwave=true,
    aExt=0.6,
    hConWallOut=24.669999999999998,
    hRad=4.63,
    hConWinOut=16.37,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=29.3*63.60000000000001)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=21.0*12.0)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Project_2/json_based_building/json_based_building_Models/InternalGains_json_based_buildingTestRoom600.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1406.4)
...
equation
  ...
  events=false));
end json_based_building_TestRoom600;
