...
model python_based_building_Office
  "This is the simulation model of Office within building python_based_building with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.005987620602778296},
    CExt={1916708.8321619383},
    hRad=5.0,
    AInt=1.9689999999999996,
    hConInt=2.253072625698324,
    nInt=1,
    RInt={0.029129873413207042},
    CInt={268126.82119816716},
    RWin=0.23568575924403884,
    RExtRem=0.3960966492186491,
    AFloor=0.2529999999999999,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0914175008709287},
    RFloorRem=6.251514929018025,
    CFloor={20353.66513195187},
    ARoof=0.2529999999999999,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.09402405851535348},
    RRoofRem=7.63102516851016,
    CRoof={92563.36076758882},
    ...
    nOrientations=4,
    AWin={0.0051361652497357285, 0.7547929801785549, 0.7547929801785549, 0.0051361652497357285},
    ATransparent={0.0051361652497357285, 0.7547929801785549, 0.7547929801785549, 0.0051361652497357285},
    AExt={0.015408495749207184, 2.2643789405356647, 2.2643789405356647, 0.015408495749207184})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.0033793711431090215, 0.496620628856891, 0.496620628856891, 0.0033793711431090215},
    wfWin={0.0033793711431090207, 0.496620628856891, 0.496620628856891, 0.0033793711431090207},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*4.559574872569744)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*1.5198582908565812)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Project_1/python_based_building/python_based_building_Models/InternalGains_python_based_buildingOffice.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=6.324999999999998)
...
equation
  ...
  events=false));
end python_based_building_Office;
