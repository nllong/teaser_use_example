...
model python_based_building_Meeting
  "This is the simulation model of Meeting within building python_based_building with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=0.3579999999999999,
    hConInt=2.2530726256983242,
    nInt=1,
    RInt={0.16021430377263868},
    CInt={48750.33112693949},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Project_1/python_based_building/python_based_building_Models/InternalGains_python_based_buildingMeeting.txt"),
    columns={2,3,4})
...
equation
  ...
  events=false));
end python_based_building_Meeting;
