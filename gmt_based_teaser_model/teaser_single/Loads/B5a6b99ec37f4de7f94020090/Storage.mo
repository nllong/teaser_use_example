...
model Storage
  ...
  parameter Integer nPorts=1 "Number of fluid ports." annotation(connectorSizing=true);
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={9.309864576304464e-05},
    CExt={123272741.49819629},
    hRad=4.999999999999999,
    AInt=4161.662463000001,
    hConInt=2.471428571428571,
    nInt=1,
    RInt={1.870140824070809e-05},
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.45758467583140006, 0.042415324168599944, 0.042415324168599944, 0.45758467583140006},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=24.999999999999996*293.2481372113139)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*97.74937907043794)
