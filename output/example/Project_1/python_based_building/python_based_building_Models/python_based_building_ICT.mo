...
model python_based_building_ICT
  "This is the simulation model of ICT within building python_based_building with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=0.19799999999999998,
    hConExt=2.7,
    hConWin=2.7,
    gWin=0.67,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.06586382663056127},
    CExt={174246.2574692671},
    hRad=4.999999999999999,
    AInt=0.17899999999999994,
    hConInt=2.2530726256983242,
    nInt=1,
    RInt={0.32042860754527736},
    CInt={24375.165563469745},
    RWin=2.592543351684428,
    RExtRem=4.357063141405141,
    AFloor=0.02299999999999999,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={1.0055925095802158},
    RFloorRem=68.76666421919829,
    CFloor={1850.3331938137962},
    ARoof=0.02299999999999999,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={1.0342646436688883},
    RRoofRem=83.94127685361178,
    CRoof={8414.85097887171},
    ...
    nOrientations=4,
    AWin={0.0004669241136123389, 0.06861754365259588, 0.06861754365259588, 0.0004669241136123389},
    ATransparent={0.0004669241136123389, 0.06861754365259588, 0.06861754365259588, 0.0004669241136123389},
    AExt={0.0014007723408370166, 0.20585263095778766, 0.20585263095778766, 0.0014007723408370166})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*0.41450680659724937)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*0.13816893553241644)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Project_1/python_based_building/python_based_building_Models/InternalGains_python_based_buildingICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=0.5749999999999997)
