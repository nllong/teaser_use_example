...
model python_based_building_Floor
  "This is the simulation model of Floor within building python_based_building with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=2.945,
    hConInt=2.428353140916808,
    nInt=1,
    RInt={0.024692027349230632},
    CInt={310446.9183001708},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Project_1/python_based_building/python_based_building_Models/InternalGains_python_based_buildingFloor.txt"),
    columns={2,3,4})
...
equation
  ...
  events=false));
end python_based_building_Floor;
