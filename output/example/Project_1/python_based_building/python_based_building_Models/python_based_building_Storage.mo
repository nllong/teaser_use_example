...
model python_based_building_Storage
  "This is the simulation model of Storage within building python_based_building with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=2.7720000000000002,
    hConExt=2.6999999999999997,
    hConWin=2.7000000000000006,
    gWin=0.67,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00470455904504009},
    CExt={2439447.6045697397},
    hRad=5.0,
    AInt=2.5060000000000002,
    hConInt=2.2530726256983242,
    nInt=1,
    RInt={0.02288775768180552},
    CInt={341252.3178885765},
    RWin=0.1851816679774591,
    RExtRem=0.31121879581465295,
    AFloor=0.3219999999999999,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.07182803639858683},
    RFloorRem=4.91190458708559,
    CFloor={25904.664713393428},
    ARoof=0.3219999999999999,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.07387604597634916},
    RRoofRem=5.995805489543696,
    CRoof={117807.91370420394},
    ...
    nOrientations=4,
    AWin={0.006536937590572746, 0.9606456111363426, 0.9606456111363426, 0.006536937590572746},
    ATransparent={0.006536937590572746, 0.9606456111363426, 0.9606456111363426, 0.006536937590572746},
    AExt={0.019610812771718233, 2.8819368334090276, 2.8819368334090276, 0.019610812771718233})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.0033793711431090215, 0.49662062885689096, 0.49662062885689096, 0.0033793711431090215},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant hConWall(k=25.0*5.803095292361491)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*1.9343650974538307)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Project_1/python_based_building/python_based_building_Models/InternalGains_python_based_buildingStorage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=8.049999999999999)
...
equation
  ...
  events=false));
end python_based_building_Storage;
